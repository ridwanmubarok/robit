                        ...
                        <div className="flex flex-col items-center mb-2">
                            <div className="flex items-center space-x-3 mb-4">
                                ...
                                <div className="flex items-baseline space-x-2">
                                    ...
                                    <span className="text-[12px] uppercase font-mono tracking-wider text-neutral-500">v0.4.2</span>
                                </div>
                            </div>
                            <h2 className="text-xl font-medium tracking-tight text-white">Welcome to your Workspace</h2>
                        </div>
                                ...
                                <div key={i} className="flex justify-start w-full max-w-4xl mx-auto px-4 fade-in">
                                    <div className="w-full max-w-[85%]">
                                        <div className="flex items-center gap-1.5 pl-1 mb-0.5">
                                            ...
                                            <span className="text-[10px] font-bold text-neutral-500 uppercase tracking-wider">System - Tool Execution</span>
                                        </div>
                                        {parts.map((part, idx) => (
